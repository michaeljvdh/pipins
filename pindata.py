...
def generatepins():
    ...
    x ('UPDATE pindata SET assign="+3.3v" WHERE pin="1"')
    x ('UPDATE pindata SET intended="+5v" WHERE pin="2"')
    x ('UPDATE pindata SET assign="+5v" WHERE pin="2"')
    x ('UPDATE pindata SET intended="GPIO 0 (I2C0 SDA)" WHERE pin="3"')
    x ('UPDATE pindata SET intended="+5V" WHERE pin="4"')
    x ('UPDATE pindata SET assign="+5V" WHERE pin="4"')
    ...
    x ('UPDATE pindata SET assign="GND" WHERE pin="14"')
    ...
    x ('UPDATE pindata SET assign="GPIO +3.3v" WHERE pin="17"')
    ...
    x ('UPDATE pindata SET assign="GND" WHERE pin="20"')
    ...
    x ('UPDATE pindata SET assign="GND" WHERE pin="25"')
...
while true:
    ...
    print "pinpin's for Rasppberry Pi Version B (512MB)"
    print '-----------------------------------------------------------'
    print '%-5s %-30s %-20s' % ("Pin","Your Description","Default Assignment")
    print '-----------------------------------------------------------'
    for i in result:
    ...
    print 26 - result[0], ("Pin(s) not used or not configured")
    print '-----------------------------------------------------------'
